...
// Note that in the example inputs (not outputs) below, arrays such as [2,1,5] represent the serialization of a linked list with a head node 
...
var nextLargerNodes = function(head) {
    ...
    while (curr) {
        ...
        if (!next) output.push(0);
        else output.push(next.val); 
        curr = curr.next;
    }
