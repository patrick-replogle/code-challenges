...
ParkingSystem(int big, int medium, int small) Initializes object of the ParkingSystem class. The number of slots for each parking 
...
class ParkingSystem {
    ...
    addCar(car) {
        ...
        else if (car === 2 && this.medium > 0) {
            this.medium--;
            flag = true;
        }
        else if (car === 3 && this.small > 0) {
            this.small--;
            flag = true;
        }
        return flag;
