/*
As the head of a company you decided that it's time to introduce access control and to restrict access to employees table for all the employees. 
...
Create a view which will select all the columns from the employees table but leave only id and name intact. date_joined column should contain the 
year the employee joined the company, and salary column should be filled with - (single dashes).
